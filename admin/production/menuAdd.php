                    ...
                    <form action="../operation/operation.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="menu_name"  required="required" placeholder="Menü adını giriniz" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
            ...
            <!--CK Editör  end -->
             <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="menu_order" placeholder="Menü sıra giriniz"  required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
