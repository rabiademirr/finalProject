      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../operation/operation.php" method="POST">
            ...
            <div>
              <input type="text" name="user_mail" class="form-control" placeholder="Kullanıcı Adınız (Mail)" required="" />
            </div>
            <div>
              <input type="password" name="user_password" class="form-control" placeholder="Şifreniz" required="" />
            </div>
            <div>
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Lively Garden</h1>
                <p>©2021 Lively Garden</p>
              </div>
            </div>
          </form>
